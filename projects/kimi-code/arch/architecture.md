...
> 分析版本：`v0.31.1`；精确源码提交：`e22479a62eed9c3b78a67b313f4332c2c0ba9670`。本文是早期整体结构笔记，当前 v0.40.0 的演进分析见 [`research/kimi-code-harness-evolution.md`](../research/kimi-code-harness-evolution.md)。
